...
<body class="sidebar-collapsed">
    ...
    <div class="chart-and-interpretation">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                <h3>Most Requested Subject(s)</h3>
                <?php if (!empty($mostRequestedSubjects)): ?>
                    <ul class="subject-list">
                        <?php foreach ($mostRequestedSubjects as $subject): ?>
                            <li><?= htmlspecialchars($subject) ?> (<?= $mostRequestedCount ?> bookings)</li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
            ...
            <div class="summary-card">
                ...
                <?php if (!empty($zeroRequestedSubjects)): ?>
                    <ul class="subject-list">
